...
pub async fn player_task(
    ...
    // bit_clock_pin : embassy_rp::Peri<'static, embassy_rp::peripherals::PIN_23>,
    // left_right_clock_pin : embassy_rp::Peri<'static, embassy_rp::peripherals::PIN_25>,
    // data_pin :  embassy_rp::Peri<'static, embassy_rp::peripherals::PIN_24>,
) {
